...
## 📷 Приклади / скриншоти
  ...
  - Головна сторінка з інструкцією.
  - Сторінка реєстрації з генератором паролів.
  - Список збережених даних (з пошуком, сортуванням, пагінацією).
  - Сторінка деталей запису (з формою введення пароля).
  - Сторінка надання доступу.
  - Сторінка керування 2FA (з QR-кодом або кодами відновлення).
...
## 🧾 Використані джерела / література
  ...
  - Документація Entity Framework Core (docs.microsoft.com/ef/core)
  - Документація ASP.NET Core Identity (docs.microsoft.com/aspnet/core/security/authentication/identity)
  - Документація по System.Security.Cryptography (.NET)
  - Стандарти RSA, AES, PBKDF2, SHA, TOTP.
  - 
---
## Screenshots
